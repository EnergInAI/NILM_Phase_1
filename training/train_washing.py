...
ON_THRESHOLD = 0.03          # kW (50W, captures rinse/spin)
ON_RATIO = 0.6               # 60% ON, 40% OFF
ON_WEIGHT = 6.0              # mild emphasis
PATIENCE = 6
...
for b in TRAIN_BUILDINGS:
    try:
        ...
        wm_df = read_meter(H5_PATH, b, WM_METER)
...
print("🏁 Washing Machine training finished")
